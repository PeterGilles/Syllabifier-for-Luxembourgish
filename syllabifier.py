...
Luxembourgish = {
	...
	'onsets': ['b', 'b l', 'b ʀ', 'ɕ', 'd', 'd̥', 'ð', 'd ʀ', 'dʒ', 'dʒ w', 'f', 'f i̯', 'f l', 
	'f ʀ', 'ɡ', 'ɡ l', 'ɡ ʀ', 'h', 'i̯', 'j', 'k', 'k l', 'k n', 'k ʀ', 'k s', 'k w', 'l', 
	'm', 'm i̯', 'n', 'n i̯', 'ɲ', 'p', 'p l', 'p ʀ', 'p s', 'p w', 'pf', 'pf l', 'pf ʀ', 'ʀ', 
	'ʀ i̯', 's', 's i̯', 'ʃ', 'ʃ i̯', 'ʃ l', 'ʃ m', 'ʃ n', 'ʃ p', 'ʃ p l', 'ʃ p ʀ', 'ʃ ʀ', 
	'ʃ t', 'ʃ t ʀ', 'ʃ v', 't', 't i̯', 't ʀ', 't ʃ', 't w', 'ts', 'ts i̯', 'ts w', 'v', 'z', 
	'z i̯', 'ʑ', 'ʒ', 'ʒ i̯', 'χ']
	}
