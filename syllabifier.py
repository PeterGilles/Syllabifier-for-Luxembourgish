...
Luxembourgish = {
	'consonants': ['b', 'ɕ', 'd', 'd̥', 'ð', 'dʒ', 'f', 'ɡ', 'h', 'i̯', 'j', 'k', 'l', 'm', 'n', 
	...
	'onsets': ['b', 'b i̯', 'b l', 'b ʀ', 'ɕ', 'd', 'd̥', 'ð', 'd ʀ', 'dʒ', 'dʒ w', 'f', 'f ɥ', 'f i̯', 'f l', 
	'f ʀ', 'ɡ', 'ɡ l', 'ɡ ʀ', 'h', 'i̯', 'j', 'k', 'k ɥ', 'k l', 'k n', 'k ʀ', 'k s', 'k w', 'l', 
	'm', 'm i̯', 'n', 'n i̯', 'ɲ', 'p', 'p ɥ', 'p i̯', 'p l', 'p ʀ', 'p s', 'p w', 'p f', 'p f l', 'ʀ', 
	'ʀ i̯', 's', 's ɥ', 's i̯', 'ʃ', 'ʃ i̯', 'ʃ l', 'ʃ m', 'ʃ n', 'ʃ p', 'ʃ p l', 'ʃ p ʀ', 'ʃ ʀ', 
	'ʃ t', 'ʃ t ʀ', 'ʃ v', 'ʃ w', 't', 't i̯', 't ʀ', 't ʃ', 't w', 'ts', 'ts i̯', 'ts ʀ', 'ts w', 'v', 'v ʀ', 'z', 
	'z i̯', 'ʑ', 'ʒ', 'ʒ i̯', 'χ']
	}
